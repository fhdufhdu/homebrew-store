...
cask "flex-menubar" do
  ...
  url "https://github.com/fhdufhdu/flex-work-record-calculator-menubar-app/releases/download/v#{version}/flex-menubar.zip"
  name "flex-menubar"
  desc "flex.team 주간 근무시간을 macOS 메뉴바에 표시"
  homepage "https://github.com/fhdufhdu/flex-work-record-calculator-menubar-app"
